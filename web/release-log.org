...
[[file:index.org][Clojure Box Home]]

#+BEGIN_HTML Disable stock H1 title
<style type="text/css">
...
- Built with the official 1.1RC1 release from clojure.org. Contrib is from
...
- Patched swank-clojure to fix slime-edit-definition to use platform-agnostic
  separators.
